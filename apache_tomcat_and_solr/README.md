...
Uninstall  C:\Program Files\Apache Software Foundation\Tomcat 10.1 ust for test and install again.

![uninstall_tomcat](https://github.com/spawnmarvel/quickguides/blob/main/apache_tomcat_and_solr/images/uninstall_tomcat.png)
...
## tomcat10w.exe GUI stderr.log / stdout.log – Captures system errors and console outputs.
...
To log to standard output (stdout) using the print function in Python, you don't need any special configuration—the print() function writes to stdout by default.
