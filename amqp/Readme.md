...
* 4 VM1 (Shovel client) Enable rabbitmq_management, rabbitmq_shovel and rabbitmq_shovel_management
* * Cd to sbin
* * rabbitmq-plugins list
* * rabbitmq-plugins enable <plugin-name>
* * rabbitmq-plugins list -e To list the enabled plugins()
...
* 8 Make the queues on VM1 as (auto-create in the shovel), if the shovel is running then GOTO 9
